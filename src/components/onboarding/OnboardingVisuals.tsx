  ...
  return (
    <div className="relative w-full max-w-[260px] mx-auto h-[210px] flex items-center justify-center">
      ...
      <motion.div
        ...
        className="absolute -left-1 bottom-16 w-10 h-10 rounded-xl bg-indigo-500/15 border border-indigo-500/25 flex items-center justify-center backdrop-blur-sm"
      >
...
export function ScreenTimePermissionStep({
  ...
  return (
    <div className="flex flex-col items-center text-center w-full">
      <div className="w-16 h-16 rounded-2xl bg-indigo-500/15 border border-indigo-500/20 flex items-center justify-center mb-6">
        ...
        <>
          ...
          {granted ? (
            ...
            <button
              type="button"
              onClick={onRequest}
              className="w-full max-w-xs h-12 rounded-2xl bg-indigo-500/20 border border-indigo-500/35 text-indigo-200 font-semibold text-sm hover:bg-indigo-500/30 active:scale-[0.98] transition-all"
            >
          ...
          {granted ? (
            ...
            <button
              ...
              className={cn(
                ...
                'bg-indigo-500/20 border border-indigo-500/35 text-indigo-200 hover:bg-indigo-500/30'
              )}
            >
